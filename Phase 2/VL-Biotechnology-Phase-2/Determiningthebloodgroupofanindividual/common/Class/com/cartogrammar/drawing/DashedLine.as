...
package com.cartogrammar.drawing {
	...
	public class DashedLine extends Sprite {
		...
		var curIndex:int;	// current index in the length array, so we know which dash or gap to draw
		...
		public function DashedLine(weight = 0, color = 0, lengthsArray:Array = null){
